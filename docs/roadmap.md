...
documentation page intentionally does not maintain a second versioned roadmap,
because duplicated release plans had drifted from the repository's actual
state.
