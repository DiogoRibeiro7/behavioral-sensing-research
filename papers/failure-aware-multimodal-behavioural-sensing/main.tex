...
unscored. Balanced accuracy is its pre-specified primary outcome and abstention
a secondary one, and that ordering stands; abstention is simply where the
present evidence leaves the largest open question. On the present evidence the framework does not yet
